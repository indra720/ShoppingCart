...
import NaviIndex from "./Navigation/NaviIndex";
  ...
  return (
    <>
      <header className="bg-white">
            ...
            <div className="flex items-center justify-between">
              <div className="col1 w-[50%]">
                <p className="text-[12px] font-[500]">
                  Get up to 50% off mew season styels, limited time
                </p>
              </div>
        ...
        <div className="header py-4 border-t-[1px] border-gray-250">
          <div className="container flex items-center justify-between">
            <div className="col1 w-[25%]">
              <Link to={"/"}>
                <img src="/src/assets/classi_logo.jpg" alt="" />
              </Link>
            </div>
            ...
            <div className="col3 w-[30%] pl-7 flex items-center">
